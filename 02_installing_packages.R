...
# - pacchetti esterni da CRAN, come "imagery" che si trova su GitHub > install_github MA per usare questa dobbiamo usare un'altra funzione, che è devtools(che è su CRAN)

install.packages("devtools") #ricordati sempre le virgolette
#dev.tools::install_github
library(devtools) #or require()


#installiamo la repository imageRy
